...
from logica.logica_traer_soportes_ratificadas import WorkerTraerSoportesRatificadas
...
class WidgetTraerSoportesRatificadas(QWidget):
    ...
    def iniciar_proceso(self):
        ...
        self.thread = QThread()
        self.worker = WorkerTraerSoportesRatificadas(numeros_factura, dir_busqueda, dir_destino)
