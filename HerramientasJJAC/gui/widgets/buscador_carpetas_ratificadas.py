...
from logica.workers.buscador_carpetas_ratificadas_logic import BuscadorCarpetasRatificadasWorker
...
class BuscadorCarpetasRatificadasWidget(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def iniciar_procesamiento(self):
        ...
        self.worker = BuscadorCarpetasRatificadasWorker(codigos, carpeta_busqueda, carpeta_destino)
