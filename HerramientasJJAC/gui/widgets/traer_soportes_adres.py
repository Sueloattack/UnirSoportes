# gui/widgets/traer_soportes_adres.py
import sys
...
# Se importará el worker actualizado más adelante
from logica.workers.traer_soportes_adres_logic import TraerSoportesAdresWorker

class TraerSoportesAdresWidget(QWidget):
    def __init__(self):
        super().__init__()
        self.worker = None
        self.thread = None
    ...
    def crear_widgets(self):
        ...
        self.line_busqueda.setPlaceholderText("Seleccione la carpeta de búsqueda (la que contiene las cuentas de cobro).")
    ...
    def iniciar_proceso(self):
        ...
        self.thread = QThread()
        self.worker = TraerSoportesAdresWorker(facturas_con_serie, dir_busqueda, dir_destino)
    ...
    def finalizar_proceso(self):
        ...
        self.thread = None
        self.worker = None
        QMessageBox.information(self, "Proceso Finalizado", "El proceso de traer soportes ADRES ha terminado.")
