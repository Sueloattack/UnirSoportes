...
from logica.workers.reorganizador_sedes_logic import ReorganizadorSedesWorker
...
class ReorganizadorSedesWidget(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def iniciar_procesamiento(self):
        ...
        self.worker = ReorganizadorSedesWorker(carpeta_raiz)
