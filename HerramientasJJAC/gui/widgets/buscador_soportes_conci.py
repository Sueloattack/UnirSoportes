# gui/widgets/buscador_soportes_conci.py
import sys
...
from logica.workers.buscador_soportes_conci_logic import BuscadorSoportesConciWorker

class BuscadorSoportesConciWidget(QWidget):
    def __init__(self):
        super().__init__()
        self.worker = None
        self.thread = None
    ...
    def crear_widgets(self):
        ...
        label_titulo = QLabel("Buscador de Soportes CONCI (Conciliación)")
        ...
        self.line_busqueda.setPlaceholderText("Seleccione la carpeta raíz de búsqueda (donde están las carpetas de respuestas).")
        ...
        self.line_destino.setPlaceholderText("Selecciona la carpeta de destino para los soportes agrupados.")
        ...
        self.btn_iniciar = QPushButton("Iniciar Búsqueda CONCI")
    ...
    def iniciar_proceso(self):
        ...
        self.log_viewer.append("Iniciando proceso CONCI...")
        
        self.thread = QThread()
        self.worker = BuscadorSoportesConciWorker(facturas_con_serie, dir_busqueda, dir_destino)
    ...
    def finalizar_proceso(self):
        ...
        self.worker = None
        if self.cancelacion_solicitada:
            QMessageBox.information(self, "Proceso detenido", "La búsqueda de soportes CONCI fue detenida.")
        else:
            QMessageBox.information(self, "Proceso Finalizado", "La búsqueda de soportes CONCI ha terminado.")
        self.cancelacion_solicitada = False

    def _actualizar_estado_ejecucion(self, en_ejecucion: bool):
        self.btn_iniciar.setText("Procesando..." if en_ejecucion else "Iniciar Búsqueda CONCI")
