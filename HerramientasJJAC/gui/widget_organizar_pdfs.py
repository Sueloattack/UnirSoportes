...
from logica.logica_organizar_pdfs import WorkerOrganizarPDFs
...
class WidgetOrganizarPDFs(QWidget):
    def __init__(self):
        super().__init__()
        self.ruta_raiz = ""
    ...
    def iniciar_procesamiento(self):
        ...
        self.worker = WorkerOrganizarPDFs(self.ruta_raiz, self.ruta_respuestas, self.mover_archivos)
